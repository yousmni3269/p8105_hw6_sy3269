...
To further improve the model, cross validation is performed. 
The linear model above is compared with a smooth model. 
...
According to the violin plot, smooth model seems to a better option than the linear one. 
I will finalize my model as below. 
